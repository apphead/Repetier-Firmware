...
#define NUMTEMPS_15 27 // DYZE DESIGN 500Ã‚Â°C Thermistor
...
#endif
        break;
    case 100: // AD595 / AD597   10mV/Ã‚Â°C
        ...
        if(heating == false && currentTemp < temp) {
            if(time - t1 > (controllerId < NUM_EXTRUDER ? 5000 : 3000)) {
                ...
                if(cycles > 0) {
                    ...
                    if(cycles > 2) {
                        // Parameter according ZieglerÃ‚Â¡Ã‚Â§CNichols method: http://en.wikipedia.org/wiki/Ziegler%E2%80%93Nichols_method
