...
// then you have 3 seconds of increased heating to reach 1Ã‚Â°Ã¢â‚¬Å¾C.
...
// 13 is PT100 for E3D/Ultimaker
// 14 is 100K NTC 3950
// 15 DYZE DESIGN 500Ã‚Â°C Thermistor
// 16 is B3 innovations 500Ã‚Â°C sensor
...
#define EXT0_PID_PGAIN_OR_DEAD_TIME   8.7
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   0.9
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 21.4
...
/** P-gain.  Overridden if EEPROM activated. */
#define EXT1_PID_PGAIN_OR_DEAD_TIME   8.7
/** I-gain.  Overridden if EEPROM activated.
*/
#define EXT1_PID_I   0.9
/** D-gain.  Overridden if EEPROM activated.*/
#define EXT1_PID_D 21.4
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
parameter to then tangents of the deviation from 90Ã‚Â° when you print a square object.
E.g. if you angle is 91Ã‚Â° enter tan(1) = 0.017. If error doubles you have the wrong sign.
Always hard to say since the other angle is 89Ã‚Â° in this case!
*/
...
405 or CONTROLLER_FELIX_DUE Felix LCD fÃƒÂ¼r due based board
